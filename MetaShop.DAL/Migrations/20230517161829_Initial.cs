        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ProductAssetId = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductInformation_Asset_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Asset",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductInformation_Attribute_AttributeId",
                        column: x => x.AttributeId,
                        principalTable: "Attribute",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductInformation_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CouponMinSpend = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CouponMaxSpend = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CouponUserPerCustomer = table.Column<int>(type: "int", nullable: false),
                    CouponUserPerCoupon = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductInformation_AssetId",
                table: "ProductInformation",
                column: "AssetId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductInformation_AttributeId",
                table: "ProductInformation",
                column: "AttributeId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Asset_ProductAsset_ProductAssetId",
                table: "Asset",
                column: "ProductAssetId",
                principalTable: "ProductAsset",
                principalColumn: "Id");
